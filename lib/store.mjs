...
`;
// Note: the tasks table is purely additive and never read by older code, so it
// ships WITHOUT a SCHEMA_VERSION bump — that keeps long-running v2 MCP servers in
// the live fleet from tripping the "schema ahead" degraded flag.
