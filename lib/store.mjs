...
`;
// Note: the tasks/decisions tables are purely additive and never read by older
// code, so they ship WITHOUT a SCHEMA_VERSION bump — that keeps long-running v2
// MCP servers in the live fleet from tripping the "schema ahead" degraded flag.
